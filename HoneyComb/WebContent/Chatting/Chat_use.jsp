		...
		//	 alert("chat_Num :::::: "+chat_Num+"   chat_mem_name:::::: "+chat_mem_name+" chat_Member_Participation :::::: "+chat_Member_Participation+" chat_partner :::::: "+chat_partner)
	        ...
	        Chat.initialize = function() {
	            if (window.location.protocol == 'http:') {
	            	...
	            	Chat.connect('ws://192.168.123.105:8888/HoneyComb/websocket/Chatting?mem_name='+mem_num+'&receiver='+chat_Member_Participation+'&chat_Num='+chat_Num+'&my_name='+my_Name);
	            } else {
